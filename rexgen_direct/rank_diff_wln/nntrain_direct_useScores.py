...
from rexgen_direct.rank_diff_wln.mol_graph_direct_useScores import atom_fdim as adim, bond_fdim as bdim, max_nb, smiles2graph
...
parser.add_option("-p", "--cand", dest="cand_path", default='../core_wln_global/model-300-3-direct/train.cbond_detailed')
parser.add_option("-b", "--batch", dest="batch_size", default=4)
parser.add_option("-a", "--ncand", dest="cand_size", default=50)
...
candidates = candidates - reactant       # diff
